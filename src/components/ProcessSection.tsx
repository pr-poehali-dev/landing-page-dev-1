  ...
  return (
    ...
    >
      <div className="container mx-auto px-4 relative z-10">
        <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold mb-10 sm:mb-12 lg:mb-16 leading-tight max-w-3xl">
          <span className="text-lp-blue">Понятный процесс</span>{' '}
          <span className="text-gray-900">от идеи до готового сайта</span>
        </h2>

        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-x-8 sm:gap-x-12 gap-y-10 sm:gap-y-12 lg:gap-y-16">
          {steps.map((step) => (
            <div key={step.number} className="space-y-3 sm:space-y-4">
              <div className="space-y-2">
                <div className="text-4xl sm:text-5xl lg:text-6xl font-bold text-lp-blue">
                  {step.number}
                </div>
                <div className="w-12 h-1 bg-gray-900"></div>
              </div>
              
              <h3 className="text-lg sm:text-xl font-bold text-lp-blue uppercase">
                {step.title}
              </h3>

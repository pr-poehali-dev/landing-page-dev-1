        ...
        <div className="max-w-7xl mx-auto flex flex-col lg:flex-row items-center justify-between gap-6 sm:gap-8">
          ...
          <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 flex-shrink-0">
            <a
              ...
              className="inline-flex items-center justify-center gap-2 sm:gap-3 px-6 sm:px-8 py-3 sm:py-4 bg-[#0088cc] hover:bg-[#0077b3] text-white text-sm sm:text-base font-semibold rounded-xl transition-colors duration-200 shadow-sm"
            >
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center justify-center gap-2 sm:gap-3 px-6 sm:px-8 py-3 sm:py-4 bg-[#25D366] hover:bg-[#20BD5A] text-white text-sm sm:text-base font-semibold rounded-xl transition-colors duration-200 shadow-sm"
            >
